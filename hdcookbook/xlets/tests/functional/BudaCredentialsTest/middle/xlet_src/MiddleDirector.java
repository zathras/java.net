...
public class MiddleDirector extends Director implements Runnable {
            ...
            throws IOException 
    {
        ...
        // 12.6.2.7.2 says:
        //
        //    An application's right to access a ﬁle is the union of the 
        //    rights granted by the credential mechanism and the right 
        //    granted by the ﬁle permission mechanism.
        //
    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                Debug.printStackTrace(ex);
                fail = true;
                results.add("File from creator not present:  " + ex.toString());
            }
