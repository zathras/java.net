...
public class DestroyerDirector extends Director implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                results.add("Failed read:  " + ex);
                fail = true;
            }
            testWrite(dir, "output_1.txt", "First file contents modified");
            testRead(dir, "output_1.txt", "First file contents modified");
            testRead(dir, "output_2.txt", "Second file contents");
            testWrite(dir, "output_2.txt", "Second file - modified");
            testRead(dir, "output_2.txt", "Second file - modified");
            testWrite(dir, "output_3.txt", "Third file - modified");
            testRead(dir, "output_3.txt", "Third file - modified");
            testDelete(dir, "output_1.txt");
            testDelete(dir, "output_2.txt");
            testDelete(dir, "output_3.txt");
